...
if(isset($_REQUEST['btn-submit'])){
    ?>
    <script>
        window.open("https://www.tgcindia.com/adwords/video-editing-course/assets/images/courses/ADOBE_PREMIERE_PRO.pdf", "_blank");
    </script>
<?php
}
?>
...
$toaddress='tgcanimation@gmail.com,info@tgcindia.com,ranjan354@gmail.com';
...
//  if(isset($_REQUEST['btn-submit'])){
// 	echo '<script>window.open("ADOBE_PREMIERE_PRO.pdf");</script>';
// 	}
